...
export function decode(keyVal: KeyValue): SilentPaymentV0Info {
...
export function encode(data: SilentPaymentV0Info): KeyValue {
...
export function check(data: any): data is SilentPaymentV0Info {
  return (

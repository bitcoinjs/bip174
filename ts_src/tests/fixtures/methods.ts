...
const dummyXOnlyPubkey = (): Buffer => dummyPubkey().slice(1);
const dummyControlBlock = (): Buffer =>
  Buffer.from(
    'c1' +
...
const dummyLeafHash = (): Buffer => dummyControlBlock().slice(-32);
const dummyLeafHash2 = (): Buffer => dummyControlBlock().slice(-64, -32);
